...
function TopBlogCard({
  ...
  return (
    <a href={`/blog/${BlogId}`} className="flex flex-row items-center space-x-2 min-h-[200px] bg-white cursor-pointer border border-gray-200 rounded-lg overflow-hidden shadow hover:bg-gray-50">
